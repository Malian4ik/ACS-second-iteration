...
export function getRoomCards(locale: Locale): RoomCard[] {
  return locale === "ru"
    ...
    : [
        { key: "solo-core", format: "solo", title: "Stream Room", subtitle: "A solo room for a private session", description: "Designed for streaming, focused gaming and longer stays without shared-hall noise.", price: "Check details in Telegram", duration: "1–4 hours", capacity: "1 player", image: "/images/cyberclub-card.jpg", features: ["Private seating", "Content-friendly setup", "Fast entry into game mode"] },
        { key: "solo-night", format: "solo", title: "Solo Night", subtitle: "Late-night format for longer stays", description: "For guests who come in for a full evening or a night block, not just a quick session.", price: "Check details in Telegram", duration: "4 hours", capacity: "1 player", image: "/images/club-room-green.webp", features: ["Comfort over longer stays", "Easy to combine with the restaurant", "Built for a late-night flow"] },
        { key: "duo-sync", format: "duo", title: "Privat", subtitle: "A room for two", description: "A strong fit for co-op play, couples, friends and anyone who wants the club without the shared-hall atmosphere.", price: "Find the right format in Telegram", duration: "1–4 hours", capacity: "2 players", image: "/images/cyberclub-vip.jpg", features: ["TV and lounge seating", "Privacy", "Built for a shared evening"] },
        { key: "duo-premium", format: "duo", title: "Privat+ / VIP", subtitle: "An elevated private experience", description: "For guests who want more comfort, atmosphere and intimacy inside the club.", price: "Check details in Telegram", duration: "4 hours", capacity: "2–4 players", image: "/images/club-room-red.webp", features: ["Premium format", "Built for longer sessions", "Club + restaurant flow"] },
        { key: "bootcamp-squad", format: "bootcamp", title: "Bootcamp", subtitle: "A team gaming zone", description: "Built for scrims, training, team sessions and longer competitive blocks inside a private environment.", price: "Check details in Telegram", duration: "2–6 hours", capacity: "5 players", image: "/images/cyberclub-team.jpg", features: ["Team seating", "High-end setups", "Ideal for squads"] },
