      ...
      <div className="mx-auto max-w-[1640px] space-y-6">
        <div className="rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,#10141c,#0b0f15)] p-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                className="rounded-full border border-[var(--accent-red)] px-5 py-2 text-sm font-semibold text-[var(--accent-red)] transition hover:bg-[var(--accent-red)] hover:text-white"
                type="button"
                disabled={isSaving}
                onClick={async () => {
